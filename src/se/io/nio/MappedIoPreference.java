 ...
 * @author zhangyaowen
 */
public class MappedIoPreference {
        ...
        return new Tester[]{
            ...
            new Tester("Mapped Write") {
                ...
                public void test() throws IOException {
                    ...
                    IntBuffer intBuffer = fileChannel.map(FileChannel.MapMode.READ_WRITE, 0,
            ...
            new Tester("Stream Read/Write") {
                @Override
                public void test() throws IOException {
                    RandomAccessFile randomAccessFile = new RandomAccessFile(new File("temp.tmp")
                            , "rw");
            ...
            new Tester("Mapped Read/Write") {
                ...
                public void test() throws IOException {
                    FileChannel fileChannel =
                            new RandomAccessFile(new File("temp.tmp"), "rw").getChannel();
                    IntBuffer intBuffer = fileChannel.map(FileChannel.MapMode.READ_WRITE, 0,
                            fileChannel.size()).asIntBuffer();
                    intBuffer.put(0);
